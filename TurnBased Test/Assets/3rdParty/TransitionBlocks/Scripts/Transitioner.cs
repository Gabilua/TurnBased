...
public class Transitioner : MonoBehaviour
{
    ...
    public event TransitionOutComplete OnTransitionOutComplete;

    public delegate void TransitionInComplete();
    public event TransitionInComplete OnTransitionInComplete;
    ...
    private IEnumerator Transition(TransitionType transitionType)
    {
        ...
        if (transitionType == TransitionType.In)
            OnTransitionInComplete?.Invoke();
        else if (transitionType == TransitionType.Out)
