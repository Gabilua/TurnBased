...
public class CharacterInfoDisplay : MonoBehaviour
{
    ...
    public Action<StorageSlot> OnStorageSlotDroppedOnEquipment;
    ...
    void SetupEquipmentDisplays(RecruitedCharacter selectedCharacter)
    {
        for (int i = 0; i < 4; i++)
        {
            ...
            display.StorageSlotDroppedOnEquipment += StorageSlotDroppedOnEquipment;
    ...
    void StorageSlotDroppedOnEquipment(StorageSlot slot)
    {
        OnStorageSlotDroppedOnEquipment?.Invoke(slot);
    }
