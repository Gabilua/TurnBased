...
public class AICombatantController : MonoBehaviour
{
    ...
    public void SetupController()
    {
        ...
        IdentifyFactions();
        AssignCombatantSkills();
    }

    void AssignCombatantSkills()
    {
        List<SkillInfo> nativeSkills = new List<SkillInfo>();

        foreach (var equipment in _thisCombatant._characterInfo.nativeEquipmentSet.equipments)
            nativeSkills.Add(equipment.awardedSkill);

        _thisCombatant.SetupCombatantSkills(nativeSkills);
    }
